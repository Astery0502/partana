...
%% Load Data
DIM = [768,768,768]; % [n1,n2,n3]
Precision = 'double';
LIM = [-2,2,-2,2,0.0,4.0]; % [xmin,xmax,ymin,ymax,zmin,zmax]
...
Parameters.ARD_ScalarThreshold = 20;    % Threshold of DataThres
...
R0_O = [0 0 1.3] % Position of sphere center
